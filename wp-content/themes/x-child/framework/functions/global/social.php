...
if ( ! function_exists( 'x_social_global' ) ) :
  function x_social_global() {
    ...
    $output = '<div class="x-social-global">';
      ...
      if ( $facebook )    : $output .= '<a href="' . $facebook    . '" class="facebook" title="Facebook" target="_blank"><i class="x-icon-facebook" data-x-icon="&#xf09a;" aria-hidden="true"></i></a>'; endif;
      if ( $twitter )     : $output .= '<a href="' . $twitter     . '" class="twitter" title="Twitter" target="_blank"><i class="x-icon-twitter" data-x-icon="&#xf099;" aria-hidden="true"></i></a>'; endif;
      if ( $google_plus ) : $output .= '<a href="' . $google_plus . '" class="google-plus" title="Google+" target="_blank"><i class="x-icon-google-plus" data-x-icon="&#xf0d5;" aria-hidden="true"></i></a>'; endif;
