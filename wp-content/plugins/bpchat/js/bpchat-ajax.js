	...
	$(document).ready(function () {
		...
		var AjaxChat = {
			...
			createChatWindow: function (userID, userName, WindowState, userImage){
				...
				var chatWindow ='';
					chatWindow += '<div id="chat-window-id-'+userID+'" data-minimize="0" class="bpchatWindow tab-content" data-parameter-window-id="'+userID+'" data-identifier="'+userID+'" data-window-state="'+WindowState+'">';
